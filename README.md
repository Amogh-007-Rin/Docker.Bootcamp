...
## Real-World Projects
1. [Project 01 — Node.js Web App](projects/project-01-nodejs-app/README.md)
2. [Project 02 — Python Flask App](projects/project-02-python-flask-app/README.md)
3. [Project 03 — React App](projects/project-03-react-app/README.md)
4. [Project 04 — Microservices Architecture](projects/project-04-microservices/README.md)
5. [Project 05 — ML Model Serving](projects/project-05-ml-serving/README.md)
6. [Project 06 — CI/CD with GitHub Actions](projects/project-06-cicd-github-actions/README.md)
7. [Project 07 — CI/CD with Jenkins](projects/project-07-cicd-jenkins/README.md)
8. [Project 08 — Cloud Deployment](projects/project-08-cloud-deployment/README.md)

## Cheatsheets
[Docker CLI](cheatsheets/docker-cli-cheatsheet.md) ·
[Dockerfile](cheatsheets/dockerfile-cheatsheet.md) ·
[Docker Compose](cheatsheets/docker-compose-cheatsheet.md) ·
[Networking](cheatsheets/networking-cheatsheet.md) ·
